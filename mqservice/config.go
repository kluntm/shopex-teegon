...
type Config struct {
	...
	KafkaConfig      mq.KafkaConfig `json:"kafka,omitempty"`              //kafka 配置信息
	ZkList           string         `json:"zk_list,omitempty"`            //zookeeper地址
	...
	Secret           string         `json:"secret,omitempty"`             //服务sign签名的秘钥字段
